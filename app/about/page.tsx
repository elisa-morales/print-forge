        ...
        <div className='px-6 mx-auto max-w-7xl'>
          ...
          <div className='grid gap-6 md:gap-0 md:grid-cols-3'>
            <article className='p-6 bg-white'>
              ...
              <p className='text-gray-600'>Access our vast library of community-created 3D models, from practical tools to artistic creations.</p>
            </article>
            <article className='p-6 bg-white border-gray-400 md:border-x'>
              <h3 className='mb-3 text-xl font-semibold'>Active Community</h3>
              <p className='text-gray-600'>Join thousands of makers who share tips, provide feedback, and collaborate on projects.</p>
            </article>
            <article className='p-6 bg-white'>
              <h3 className='mb-3 text-xl font-semibold'>Free to Use</h3>
              <p className='text-gray-600'>Most models are free to download, with optional premium features for power users.</p>
            </article>
          </div>
        </div>
      </section>
